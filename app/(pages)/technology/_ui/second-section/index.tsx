    ...
    return (
        <div className={styles.wrapper}>
            ...
            <div className={styles['wrapper_box']}>
                ...
                />
                <video src="/videos/sat-1.webm" autoPlay playsInline loop muted />
            </div>
            <div className={styles['wrapper_box']}>
                ...
                <Article
                    ...
                    paragraphs={[
                        'We are licensing our space network globally and use licensed frequency bands, ensuring you do not need to worry about interference, quality of service, and security threats, unlike other unlicensed satellite IoT networks. Additionally, we are ITU approved, which further enhances our commitment to providing a reliable and secure service. Moreover, our frequency bands are compatible with mobile bands, so your cellular device radio can work on our satellites with no modification!'
                    ]}
                />
            </div>
        </div>
